    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card" style="width: 28rem;">
                ...
                <div class="card-body">
                    <p class="font-weight-bold">Agregue un nuevo período de solicitudes de exámenes extemporáneos. Fije la fecha de inicio y de fin del período de solicitudes.</p>
