                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('registroUsuarios') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Número de control') }}</label>

                            <div class="col-md-6">
                                <input id="num_control" type="number" class="form-control" name="num_control" required  autofocus>
                        ...
                        <div class="form-group row">
                            <label for="plan_estudio" class="col-md-4 col-form-label text-md-right">{{ __('Plan de estudio') }}</label>
